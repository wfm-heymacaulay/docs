...
[_https://oauth.workflowmax.com/oauth/authorize?response_type=code&client_id={YOURCLIENTID}&redirect_uri={YOURREDIRECTURI}&scope=_](https://oauth.workflowmax.com/oauth/authorize?response_type=code&client_id={YOURCLIENTID}&redirect_uri={YOURREDIRECTURI}&scope=)_ openid profile email workflowmax offline_access&state={YOURSTATE}&prompt=consent_
